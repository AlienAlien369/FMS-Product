...
export default function RoleModal({ role, onClose, onSaved }: Props) {
  ...
  const actionColor = (a: string) => {
    const m: Record<string, string> = {
      Read: 'bg-blue-100 text-blue-700 border-blue-200', Create: 'bg-green-100 text-green-700 border-green-200',
      Update: 'bg-yellow-100 text-yellow-700 border-yellow-200', Delete: 'bg-red-100 text-red-700 border-red-200',
      Export: 'bg-purple-100 text-purple-700 border-purple-200', Assign: 'bg-cyan-100 text-cyan-700 border-cyan-200',
      Execute: 'bg-orange-100 text-orange-700 border-orange-200', Manage: 'bg-gray-100 text-gray-700 border-gray-200',
    };
