...
builder.Services.AddDbContext<IdentityDbContext>(options =>
    options.UseNpgsql(connectionString, npgsql => npgsql.MigrationsAssembly("Freebuff.Platform.Api.Identity")));
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Freebuff Identity Service", Version = "v1" });
});
