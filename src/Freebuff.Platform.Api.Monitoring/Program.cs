...
builder.Services.AddDbContext<MonitoringDbContext>(options =>
    options.UseNpgsql(connectionString, npgsql => npgsql.MigrationsAssembly("Freebuff.Platform.Api.Monitoring")));
...
builder.Services.AddSwaggerGen(c => { c.SwaggerDoc("v1", new OpenApiInfo { Title = "Freebuff Monitoring Service", Version = "v1" }); });
