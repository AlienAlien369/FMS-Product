...
builder.Services.AddDbContext<TenantDbContext>(options =>
    options.UseNpgsql(connectionString, npgsql => npgsql.MigrationsAssembly("Freebuff.Platform.Api.Tenant")));
...
builder.Services.AddSwaggerGen(c => { c.SwaggerDoc("v1", new OpenApiInfo { Title = "Freebuff Tenant Service", Version = "v1" }); });
